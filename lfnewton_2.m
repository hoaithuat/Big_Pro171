                    ...
                    if iter <= 10
                        if iter > 2
                            if Qgc  < Qmin(n)
                                ...
                                busdata(n,5)=busdata(n,5)+busdata(n,7);%diem nay thi se khong lam thay doi cac ma tran dem laoi nut nguon ngs() va nss()%
                            ...
                            elseif Qgc  > Qmax(n)   % bring the generator Mvar within
                                ...
                                busdata(n,5)=busdata(n,5)+busdata(n,7);
                                busdata(n,2)=0;
                                %busdata(n,9)=0;
                                %busdata(n,10)=0;
                                Q(n)=Qmax(n)/basemva;
